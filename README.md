...
```bash
python receive_decode.py --org-image test_images\gradient.png --host 0.0.0.0 --port 5001
```
...
```bash
python receive_decode.py --host 0.0.0.0 --port 5001
```
...
```bash
python imageEncoder.py test_images\gradient.png 16
python encode_send.py image.bit --host 192.168.1.100 --port 5001
```
...
```bash
python receive_decode.py --org-image test_images\gradient.png --host 127.0.0.1 --port 5001
```
...
```bash
python imageEncoder.py test_images\gradient.png 16
python encode_send.py image.bit --host 127.0.0.1 --port 5001
```
